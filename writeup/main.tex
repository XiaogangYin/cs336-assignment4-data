...
\runningheadrule{}
\firstpageheader{CS 336}{Assignment 4}{}
\runningheader{CS 336} {Assignment 4} {Page \thepage\ of \numpages}
...
\newcommand{\hmwkTitle}{Filtering Language Modeling Data} % Assignment title
\newcommand{\hmwkClass}{CS336 Assignment \#4 (data)} % Course/class
...
\begin{questions}
    ...
    \titledquestion{Assignment Review}[0]
    \input{q1.tex}
    \newpage
   \input{q2.tex}
    \newpage
